...
function connect(service, normalize) {
  ...
  return {
    ...
    getItemIndicatorProps(props2) {
      const itemState = getOptionItemState(utils.cast(props2));
      ...
      return normalize.element({
        ...
        "data-disabled": domQuery.dataAttr(itemState.disabled),
        "data-highlighted": domQuery.dataAttr(itemState.highlighted),
        "data-state": utils.hasProp(props2, "checked") ? dataState : void 0,
        hidden: utils.hasProp(props2, "checked") ? !itemState.checked : void 0
      });
    },
  ...
  implementations: {
    ...
    actions: {
      setAnchorPoint({ context, event }) {
        context.set("anchorPoint", (prev2) => utils.isEqual(prev2, event.point) ? prev2 : event.point);
      },
