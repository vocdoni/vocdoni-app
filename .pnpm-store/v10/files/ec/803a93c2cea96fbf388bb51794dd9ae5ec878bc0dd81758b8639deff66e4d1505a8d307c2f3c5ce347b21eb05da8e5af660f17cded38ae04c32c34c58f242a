...
declare const anatomy: _zag_js_anatomy.AnatomyInstance<"root" | "item" | "ellipsis" | "firstTrigger" | "prevTrigger" | "nextTrigger" | "lastTrigger">;
...
type PropsWithDefault = "defaultPageSize" | "defaultPage" | "siblingCount" | "boundaryCount" | "translations" | "type" | "count";
...
export { type PaginationApi as Api, type ElementIds, type EllipsisProps, type IntlTranslations, type ItemLabelDetails, type ItemProps, type PaginationMachine as Machine, type PageChangeDetails, type PageSizeChangeDetails, type PageUrlDetails, type Pages, type PaginationProps as Props, type PaginationService as Service, anatomy, connect, ellipsisProps, itemProps, machine, props, splitEllipsisProps, splitItemProps, splitProps };
