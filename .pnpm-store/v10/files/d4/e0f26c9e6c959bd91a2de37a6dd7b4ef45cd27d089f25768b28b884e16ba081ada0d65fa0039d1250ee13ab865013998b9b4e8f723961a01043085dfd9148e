...
declare const anatomy: _zag_js_anatomy.AnatomyInstance<"content" | "table" | "label" | "input" | "view" | "root" | "clearTrigger" | "control" | "monthSelect" | "nextTrigger" | "positioner" | "presetTrigger" | "prevTrigger" | "rangeText" | "tableBody" | "tableCell" | "tableCellTrigger" | "tableHead" | "tableHeader" | "tableRow" | "trigger" | "viewControl" | "viewTrigger" | "yearSelect">;
...
interface DatePickerProps extends DirectionProperty, CommonProperties {
    /**
...
type PropsWithDefault = "minView" | "maxView" | "numOfMonths" | "defaultView" | "selectionMode" | "positioning" | "locale" | "timeZone" | "closeOnSelect" | "format" | "parse" | "defaultFocusedValue" | "outsideDaySelectable";
...
export { type DatePickerApi as Api, type Cell, type DateValueOffset, type DateView, type DayTableCellProps, type DayTableCellState, type ElementIds, type FocusChangeDetails, type InputProps, type IntlTranslations, type LabelProps, type LocaleDetails, type DatePickerMachine as Machine, type MonthFormatOptions, type MonthGridProps, type MonthGridValue, type OpenChangeDetails, type PresetTriggerProps, type PresetTriggerValue, type DatePickerProps as Props, type Range, type SelectionMode, type DatePickerService as Service, type TableCellProps, type TableCellState, type TableProps, type ValueChangeDetails, type ViewChangeDetails, type ViewProps, type VisibleRange, type VisibleRangeText, type WeekDay, type YearGridProps, type YearGridValue, anatomy, connect, inputProps, machine, parse, presetTriggerProps, props, splitInputProps, splitPresetTriggerProps, splitProps, splitTableCellProps, splitTableProps, splitViewProps, tableCellProps, tableProps, viewProps };
