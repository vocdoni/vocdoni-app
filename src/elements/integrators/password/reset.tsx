...
const IntegratorsPasswordReset = () => {
  ...
  return <PasswordResetForm code={code} email={email} signInRoute={Routes.integrators.signIn} />
}

export default IntegratorsPasswordReset
